...
/*
 * This class is reponsible from handling post requests from creating new users
 * and changing a users password (needs implementation).
 */
...
class Account extends Controller {
	...
	*/
	...
	/**
	 * View the password request expired page.
	 */
